...
$switch = $con->query($consulta) or die($con->error);
        ...
        <div class="pos card" id="pos">
            <div class="pos-container card-body">
                    ...
                    <div class="nav-container">
                        <div data-scrollbar="true" data-height="100%" data-skip-mobile="true">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="dash_switchs.php" data-filter="snacks">
                                        <div class="card">
                                            <div class="card-body">
                ...
                <div class="pos-content">
                    <div class="row">
                        <?php while ($dado = $switch->fetch_array()) { ?>
                            <div class="col-xl-2">
                                        ...
                                        <div class="card-body d-f text-white m-5px bg-white bg-opacity-15">
                                            <div class="flex-fill"><strong>
                                                    <div class="text-<?php echo $status_cor[$dado['status']] ?>"><?php echo $status[$dado['status']] ?>
                                                        ...
                                                        <div class="mb-1"><?php echo $dado['switch_nome'] ?>
                                                            <div class="mb-1"><?php echo $dado['switch_ip'] ?></div>
                                                        </div>
                                                    </div>
                                                </strong>
                                            </div>
